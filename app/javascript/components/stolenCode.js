const stolenCode = () => {
  ...
  function draw()
  {
      ...
      ctx.translate( window.innerWidth / 2, window.innerHeight / 2 ) // Le point d´origine du canvas est au milieu de la window
      ctx.scale(cameraZoom, cameraZoom)
      ctx.translate( -window.innerWidth / 2 + cameraOffset.x, -window.innerHeight / 2 + cameraOffset.y )
      ctx.clearRect(0,0, window.innerWidth, window.innerHeight)

      ctx.drawImage(island,-window.innerWidth / 2 ,-window.innerHeight / 2 , desiredWidth , desiredHeight);
