class LevelsController < ApplicationController
  ...
  def index
    ...
    @levels = Level.all.map {|l| {
                                   level: l,
                                   mandatory_completion: @team.get_percentage_of_level_completion(l)[:mandatory],
                                   optional_completion: @team.get_percentage_of_level_completion(l)[:optional]
                                 }
                            }
